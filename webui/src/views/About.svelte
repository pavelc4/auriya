...
<div class="view-section space-y-4">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    >
      ...
      <button
        on:click={() => openExternalLink("https://t.me/paveldiscussion")}
    ...
    >
      ...
      <div
        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-surface-variant/20 border border-outline/10 text-xs font-medium text-on-surface-variant"
      >
