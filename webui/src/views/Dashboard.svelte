    ...
    <div class="relative z-10 flex items-center justify-between">
      <div>
        <div class="flex items-center gap-3 mb-1">
          <p class="text-sm font-medium opacity-60 uppercase tracking-wider">
    ...
    <div class="bg-surface-container p-5 rounded-[32px] card_border">
      <div class="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <p class="text-sm font-mono opacity-90 break-words leading-relaxed">
            {$systemInfo.kernel}
          </p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <div>
            ...
            <div class="flex items-center gap-1">
              <h4 class="text-lg font-bold leading-none">Pavelc4</h4>
              <Icon
                name="verified"
                className="text-[var(--primary)] text-[18px]"
              />
            </div>
            <p class="text-xs opacity-50 font-mono mt-1">@pavelc4</p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="grid grid-cols-2 gap-3 mt-2">
            <button
              on:click={() =>
                openExternalLink("https://github.com/Pavelc4/Auriya")}
