...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    {type: 'category', label: 'Internals', items: ['internals/ipc-protocol', 'internals/fps-detection', 'internals/kala-research', 'internals/game-detection', 'internals/profile-scheduler', 'internals/system-tweaks']},
